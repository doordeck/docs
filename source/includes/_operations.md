...
- JWT's header is formed of the following fields:
...
- JWT's body is formed of the following fields:
...
After the request has been signed with user's private key, it should be sent to the execute endpoint as a JSON object.
